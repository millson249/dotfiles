...
files="gitconfig vimrc vim zshrc oh-my-zsh omz profile inputrc tmux.conf scripts"    # list of files/folders to symlink in homedir
xfiles="Xresources xinitrc xprofile config/i3 config/picom config/alacritty"
