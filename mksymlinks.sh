...
files="gitconfig vimrc vim janus zshrc oh-my-zsh omz vimrc.before vimrc.after profile inputrc tmux.conf"    # list of files/folders to symlink in homedir
xfiles="Xresources xinitrc xprofile config/i3"
